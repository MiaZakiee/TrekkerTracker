            ...
            <form class="loginForm" method="post">
                <div class="loginFields">
                    <div class="loginInput">
                        <label for="registerFName" style="font-family: Playfair Display">Name</label>
                    ...
                    <div class="loginInput">
                        ...
                        <input type="text" class="htmlForm-control loginTextField" name="registerUsername" placeholder="Enter your UserNa" required />
                    </div>
                    <div class="loginInput">
...
<div id="newRegisAlert" class="modal">
    <div class="modal-content">

        <p style="font-size: 28px;">You Have Registered!</p>

        <button class="close" onclick="closeModal('newRegisAlert')">OK</button>
    </div>
</div>
<div id="AlreadyUserAlert" class="modal">
    <div class="modal-content">

        <p style="font-size: 28px; color: red;">Username already existing</p>

        <button class="close" onclick="closeModal('AlreadyUserAlert')">OK</button>
    </div>
</div>
</html>
