            ...
            <form class="loginForm" method="post" >
                <div class="loginFields">
                    <div class="loginInput">
                        ...
                        <input type="text" class="htmlForm-control loginTextField" id="loginUsername" name = "loginUsername" placeholder="Enter your email" />
                    </div>
                    <div class="loginInput">
                        <label for="loginPassword" style="font-family: Playfair Display">Password</label>
                        <input type="password" class="htmlForm-control loginTextField" id="loginPassword" name = "loginPassword" placeholder="*******" />
                    </div>
