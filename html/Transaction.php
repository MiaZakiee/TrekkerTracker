<?php
session_start();
if (isset($_POST['origin']) && isset($_POST['destination']) && isset($_POST['origin_tmp']) && isset($_POST['destination_tmp']) && isset($_POST['arrival_dt']) && isset($_POST['tmp_departure_dt']) && isset($_POST['tmp_arrival_dt']) && isset($_POST['accommodation']) && isset($_POST['item_id'])) {
